...
'تعلن نقابة أساتذة الجامعات المغربية عن إطلاق برنامج جديد ومتطور للتطوير المهني...', 'Le Syndicat des Professeurs Universitaires Marocains annonce le lancement d\'un nouveau programme de développement professionnel...', 'National Union of Higher Education announces the launch of a new professional development program...',
...
-- Final message
SELECT 'Database schema created successfully for National Union of Higher Education Platform' as message;