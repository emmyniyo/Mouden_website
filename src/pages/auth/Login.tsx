        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="text-center">
            ...
            <p className="mt-2 text-sm text-gray-600">
              Bienvenue au Syndicat des Professeurs
            </p>
          </div>
          ...
          <div className="mt-6 p-4 bg-blue-50 rounded-lg">
            ...
            <div className="text-xs text-blue-600 space-y-1">
              <div><strong>Admin :</strong> admin@teachersunion.org / password</div>
              <div><strong>Éditeur :</strong> editor@teachersunion.org / password</div>
              <div><strong>Membre :</strong> member@teachersunion.org / password</div>
            </div>
          </div>
